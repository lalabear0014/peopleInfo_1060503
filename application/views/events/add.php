  ...
  <div id="main" class="row">
    ...
    <form action="<?= base_url('events/submit/'.$username) ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="txt_idnumber" class="form-control" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <input type="text" name="txt_station" class="form-control" required>
            </div>
            <label for="birthday" class="col-md-1 text-right">生日：</label>
            <div class="col-md-4">
                <div class='input-group date' id='datetimepicker'> 	
                    <input type="text" name="txt_birthday" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <div class="col-md-7">
                <textarea name="txt_education" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_experience" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea name="txt_contact" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_process" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_assess" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_use" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_money" class="form-control" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="txt_effect" class="form-control" required></textarea>
            </div>
        </div>
